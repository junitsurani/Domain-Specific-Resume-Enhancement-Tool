        ...
        with open('projects.json', 'r') as json_file:
            ...
            for skill_data in data['skills_and_projects']:
                ...
                for project_data in skill_data['related_projects']:
                    project = Project.objects.create(name=project_data['name'], description=project_data['description'], skill=skill)
                    for tech_data in project_data['suggested_technology']:
                        SuggestedTechnology.objects.create(name=tech_data, project=project)
